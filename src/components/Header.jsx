      ...
      <div className="px-6 py-4 sm:p-2 flex items-center justify-between font-heading">
        ...
        <Link to={"/cart"}>
          <div className="hover:cursor-pointer relative items-center flex sm:p-0 p-1 ">
            {cartArr.length != 0 && (
              <span className="text-sm sm:text-xl absolute bg-white left-5 bottom-8 sm:left-4 border-2  rounded-2xl border-white sm:bottom-8 w-4  text-[#C8651B] font-bold font-heading px-1">
                {cartArr.length}
              </span>
            )}
            <Icon
